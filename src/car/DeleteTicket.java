...
public class DeleteTicket extends JFrame implements ActionListener{
    ...
    public DeleteTicket(){
        ...
        panel11 = new JPanel();
        lbTitle = new JLabel(new ImageIcon(car.DeleteTicket.class.getResource("ManagerLogin.jpg")));
        panel11.add(lbTitle);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getActionCommand()=="返回"){
            ...
            String b="delete from TrainNumberTable where TrainNumber="+"'"+tNO.getText()+"'"+"";
            try{
                ...
                stat.executeUpdate();
                JOptionPane.showMessageDialog(null,"删除车票成功!","提示",JOptionPane.INFORMATION_MESSAGE);
            }
            catch(Exception e){
                e.printStackTrace();
            }
