    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==bBack){
            ...
            try{
                ...
                rs=stat.executeQuery("select distinct TrainNumber,OriginStation,TerminalStation,TicketPrice,DepartureTime,TicketsLeft,TicketAll from TrainNumberTable");
                n=0;
                while(rs.next()){
                    ...
                    a[i][6]=rs.getString("TicketsLeft");
                    i++;
